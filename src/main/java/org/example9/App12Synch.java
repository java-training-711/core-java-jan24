...
public class App12Synch {
    public static void main(String[] args) throws InterruptedException {

        int i = 0;
            IndexCounter indexCounter1 = new IndexCounter();
            IndexCounter indexCounter2 = new IndexCounter();
            indexCounter1.setStartTime(System.nanoTime());
            indexCounter2.setStartTime(System.nanoTime());

            // if 2 threads working on 2 different objects: indexCounter then they wont wait for lock during synch
        // they can easily take lock on thr indexCounter without waiting other
            Worker w1 = new Worker("W1", indexCounter1);
            Worker w2 = new Worker("W2", indexCounter2);
            w1.start();
            w2.start();
